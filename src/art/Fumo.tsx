 ...
 *
 * REJECTED FIRST PASS — the drawing is being redone; see docs/handoffs/2026-09-16-fumo-plushes.md.
 * The hair is too wide, so each plush reads as one solid mass instead of a head with twintails.
...
function sparxiePx(x: number, y: number): Px[] {
  return [
    ...
    [x + 5, y + 7, 2, 1, INK],
    [x + 10, y + 6, 2, 2, PINK], [x + 10, y + 6, 1, 1, WHITE], [x + 11, y + 7, 1, 1, WHITE],
    [x + 4, y + 8, 1, 1, BLUSH], [x + 12, y + 8, 1, 1, BLUSH],
    [x + 8, y + 9, 1, 1, '#c98d86'],
