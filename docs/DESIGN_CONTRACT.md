...
2026-09-16 owner-approved desktop tower: the empty left half of the desk's underside holds a PC case at x 118–132, standing on the floor at y=146, seen through its glass side panel, with its lead running to the wall socket that was already at x 110–115. It balances the drawer on the right and it is equipment the owner actually uses, not career signalling. Its lighting drifts between two dim colours on the room's usual two-frame swap; it is deliberately dimmer than the lamp and the window. Sits at x>=86, so unlike the sunflower it is visible at every breakpoint.
