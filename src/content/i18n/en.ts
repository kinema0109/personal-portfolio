...
export const en: LocaleContent = {
  ...
  choices: {
    ...
    album: 'The album on the desk',
    albumHint: 'Pixel art gallery',
  ...
  views: {
    ...
    gallery: ['This album collects pixel-art pictures.', 'Pick one to see it full size, and use the arrow keys to flip through.'],
  ...
  ui: {
    ...
    home: 'Home',
    next: 'Next',
    lineOf: (line, total) => `Line ${line} of ${total}`,
    hotspots: { laptop: 'See projects', album: 'Open album', drawer: 'Open CV' },
    sceneDescription:
      'Pixel art of a small apartment at night. Thọ works at a desk with a laptop and a photo album. Alhazard and Langrisser hang in a wall frame; Gran Centurio and Alpha Legion stand in the display cabinet, with Ambicion on a stand in the middle bay; Grey Seer sits on the desk. Click the laptop, the album or the desk drawer to explore.',
    ...
    gallery: {
      ...
      placeholderNote: 'Placeholder: Thọ will add the pixel-art pictures to public/gallery/.',
      prev: 'Prev',
      next: 'Next',
      close: 'Close',
    },
