...
export const ZONE_COORDS: Readonly<Record<string, readonly [number, number]>> = {
  ...
  'America/Aruba': [18.47, -66.11],
  'America/Asuncion': [-25.27, -57.67],
  'America/Atikokan': [8.97, -79.53],
  'America/Atka': [51.88, -176.66],
  ...
  'America/Blanc-Sablon': [18.47, -66.11],
  ...
  'America/Creston': [33.45, -112.07],
  'America/Cuiaba': [-15.58, -56.08],
  'America/Curacao': [18.47, -66.11],
  ...
  'America/Grenada': [18.47, -66.11],
  'America/Guadeloupe': [18.47, -66.11],
  ...
  'America/Montreal': [43.65, -79.38],
  'America/Montserrat': [18.47, -66.11],
  'America/Nassau': [43.65, -79.38],
  'America/New_York': [40.71, -74.01],
  'America/Nipigon': [43.65, -79.38],
  ...
  'America/Rosario': [-31.4, -64.18],
  'America/Santa_Isabel': [32.53, -117.02],
  ...
  'Asia/Kuala_Lumpur': [1.28, 103.85],
  'Asia/Kuching': [1.55, 110.33],
  'Asia/Kuwait': [24.63, 46.72],
  ...
  'Europe/Ljubljana': [44.83, 20.5],
  'Europe/London': [51.51, -0.13],
  'Europe/Luxembourg': [50.83, 4.33],
  'Europe/Madrid': [40.4, -3.68],
  'Europe/Malta': [35.9, 14.52],
  'Europe/Mariehamn': [60.17, 24.97],
  'Europe/Minsk': [53.9, 27.57],
  'Europe/Monaco': [48.87, 2.33],
  'Europe/Moscow': [55.76, 37.62],
  'Europe/Nicosia': [35.17, 33.37],
  'Europe/Oslo': [52.5, 13.37],
  'Europe/Paris': [48.87, 2.33],
  'Europe/Podgorica': [44.83, 20.5],
  'Europe/Prague': [50.08, 14.43],
  'Europe/Riga': [56.95, 24.1],
  'Europe/Rome': [41.9, 12.48],
  'Europe/Samara': [53.2, 50.15],
  'Europe/San_Marino': [41.9, 12.48],
  'Europe/Sarajevo': [44.83, 20.5],
  'Europe/Saratov': [51.57, 46.03],
  'Europe/Simferopol': [44.95, 34.1],
  'Europe/Skopje': [44.83, 20.5],
  'Europe/Sofia': [42.68, 23.32],
  'Europe/Stockholm': [52.5, 13.37],
  'Europe/Tallinn': [59.42, 24.75],
  'Europe/Tirane': [41.33, 19.83],
  'Europe/Tiraspol': [47, 28.83],
  'Europe/Ulyanovsk': [54.33, 48.4],
  'Europe/Uzhgorod': [50.43, 30.52],
  'Europe/Vaduz': [47.38, 8.53],
  'Europe/Vatican': [41.9, 12.48],
  'Europe/Vienna': [48.22, 16.33],
  'Europe/Vilnius': [54.68, 25.32],
  'Europe/Volgograd': [48.73, 44.42],
  'Europe/Warsaw': [52.25, 21],
  'Europe/Zagreb': [44.83, 20.5],
  'Europe/Zaporozhye': [50.43, 30.52],
  'Europe/Zurich': [47.38, 8.53],
  'GB': [51.51, -0.13],
  'GB-Eire': [51.51, -0.13],
  'Hongkong': [22.28, 114.15],
  'HST': [21.31, -157.86],
  'Iceland': [5.32, -4.03],
  'Indian/Antananarivo': [-1.28, 36.82],
  'Indian/Chagos': [-7.33, 72.42],
  'Indian/Christmas': [13.75, 100.52],
  'Indian/Cocos': [16.78, 96.17],
  'Indian/Comoro': [-1.28, 36.82],
  'Indian/Kerguelen': [4.17, 73.5],
  'Indian/Mahe': [25.3, 55.3],
  'Indian/Maldives': [4.17, 73.5],
  'Indian/Mauritius': [-20.17, 57.5],
  'Indian/Mayotte': [-1.28, 36.82],
  'Indian/Reunion': [25.3, 55.3],
  'Iran': [35.67, 51.43],
  'Israel': [31.78, 35.22],
  'Jamaica': [17.97, -76.79],
  'Japan': [35.65, 139.74],
  'Kwajalein': [9.08, 167.33],
  'Libya': [32.9, 13.18],
  'MET': [50.83, 4.33],
  'Mexico/BajaNorte': [32.53, -117.02],
  'Mexico/BajaSur': [23.22, -106.42],
  ...
  'Pacific/Pohnpei': [-9.53, 160.2],
  'Pacific/Ponape': [-9.53, 160.2],
  'Pacific/Port_Moresby': [-9.5, 147.17],
  'Pacific/Rarotonga': [-21.23, -159.77],
  'Pacific/Saipan': [13.47, 144.75],
  'Pacific/Samoa': [-14.27, -170.7],
  'Pacific/Tahiti': [-17.53, -149.57],
  'Pacific/Tarawa': [1.42, 173],
  'Pacific/Tongatapu': [-21.13, -175.2],
  'Pacific/Truk': [-9.5, 147.17],
  'Pacific/Wake': [1.42, 173],
  'Pacific/Wallis': [1.42, 173],
  'Pacific/Yap': [-9.5, 147.17],
  'Poland': [52.25, 21],
  'Portugal': [38.72, -9.13],
  'PRC': [31.23, 121.47],
  'ROC': [25.05, 121.5],
